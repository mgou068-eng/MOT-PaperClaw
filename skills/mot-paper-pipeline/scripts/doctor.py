...
def main() -> int:
    ...
    repo_ok = bool(CONFIG.github_repo) and not CONFIG.github_repo.startswith("your-github-user/")
    checks.append((repo_ok, check_mark("MOT_GITHUB_REPO", repo_ok, CONFIG.github_repo)))
