...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="MOT-PaperClaw pipeline CLI")
...
def run_command(args) -> None:
    ...
    if args.no_notify:
        notify = False
    run_mot_daily_workday.main(target_date=args.date, notify=notify, force=args.force)
...
def reconcile_command(args) -> None:
    stats_json = args.stats_json or f"memory/mot_daily_stats_{args.date}.json"
