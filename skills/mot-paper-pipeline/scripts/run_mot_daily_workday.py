...
"""
工作日 09:05 自动执行：
1) 抓取并筛选当天的多目标跟踪论文，生成/更新单篇 issue
2) 生成当天日报 issue
3) 推送日报到 Feishu 私聊
"""
...
LOCK_FILE = CONFIG.memory_dir / "mot_daily_workday.lock"
...
def _process_date(date_str: str, notify: bool, force: bool = False):
    ...
    stats_path = f"memory/mot_daily_stats_{date_str}.json"
